...
.cp-modal-head .cp-ok-ico { font-size:32px; margin-bottom:8px; }
...
.cp-sep { margin:24px 0; border:none; border-top:1px solid var(--line); }
.cp-section-head { display:flex; align-items:center; gap:10px; margin-bottom:14px; }
.cp-section-head h3 { margin:0; font-size:15px; font-weight:700; color:var(--t1); letter-spacing:-.005em; }
</style>
    ...
    <div class="cp-card">
        ...
        <div class="cp-card-body">
            ...
            <div>
                ...
                <p class="cp-hint">Nanti bisa scan QR/barcode langsung ke field ini</p>
            ...
            <div>
                ...
                <div class="cp-actions">
                    ...
                    <button
                        type="button"
                        class="cp-btn success"
                        wire:click="simpanPeminjaman"
                        wire:loading.attr="disabled"
                        wire:target="simpanPeminjaman"
                    >
